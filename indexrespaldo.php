        ...
        <header class="header">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-right">
                   <ul class="nav navbar-nav">                         <div style="float:left">                             <img src="../Vacunas/img/cintillo.png"  height="50" width="100%">                         </div>
                                      
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <i class="fa fa-user"></i>
                                <span>Booz Gomez <i class="caret"></i></span>
                            </a>
                                  ...
                                  <ul class="task-list">
                                      <li>
                                          ...
                                          <div class="task-title">
                                              <span class="task-title-sp">Pedro Zapata:</span>
                                              <span class="label label-success">2 Días</span>
                                      ...
                                      <li>
                                          ...
                                          <div class="task-title">
                                              <span class="task-title-sp">Juana Marín</span>
                                      ...
                                      <li>
                                          ...
                                          <div class="task-title">
                                              <span class="task-title-sp">Gabriela Pacheco</span>
                                              <span class="label label-warning">1 Día</span>
                                              <div class="pull-right hidden-phone">
                                                  <button class="btn btn-default btn-xs"><i class="fa fa-check"></i></button>
                                                  <button class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></button>
                                                  <button class="btn btn-default btn-xs"><i class="fa fa-times"></i></button>
                                      ...
                                      <li>
                                          ...
                                          <div class="task-title">
                                              <span class="task-title-sp">Carmen Mujíca</span>
                                              <span class="label label-primary">3 Días</span>
                                              <div class="pull-right hidden-phone">
                                                  <button class="btn btn-default btn-xs"><i class="fa fa-check"></i></button>
                                                  <button class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></button>
                                                  <button class="btn btn-default btn-xs"><i class="fa fa-times"></i></button>
                                      ...
                                      <li>
                                          ...
                                          <div class="task-title">
                                              <span class="task-title-sp">Juan Garcia</span>
                                              <span class="label label-danger">Hoy</span>
                                      ...
                                      <li>
                                          ...
                                          <div class="task-title">
                                              <span class="task-title-sp">Carla Acosta</span>
                                              <span class="label label-success">2 Días</span>
                                              <div class="pull-right hidden-phone">
                                                  <button class="btn btn-default btn-xs"><i class="fa fa-check"></i></button>
                                                  <button class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></button>
                                      ...
                                      <li>
                                          ...
                                          <div class="task-title">
                                              <span class="task-title-sp">Sofía Carmona</span>
                                              <span class="label label-danger">Hoy</span>
                                              <div class="pull-right hidden-phone">
                                                  <button class="btn btn-default btn-xs"><i class="fa fa-check"></i></button>
                                                  <button class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></button>
                                            ...
                                            <header class="panel-heading">
                                                ...
                                                <div class="panel-body" id="noti-box">
                                                    ...
                                                    <div class="alert alert-success">
                                                        ...
                                                        <strong>¡Bienvenido!</strong> Has ingresado correctamente.
                                                    </div>
