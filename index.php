...
if (!empty($chkedad)) {
    ...
    $criterio1 = $criterio1 . " edad_pac LIKE '" . $edad . "' '%'";
}
if (!empty($chksexo)) {
    if (!empty($criterio1) || !empty($criterio0)) {
        $criterio2 = " AND";
    }
    $criterio2 = $criterio2 . " sexo_pac LIKE '" . $sexo . "' '%'";
}
if (!empty($chkfecha)) {
...
$query_listado = "SELECT * FROM refuerzo_vacunas, vacunas, pacientes WHERE refuerzo_vacunas.id_paciente=pacientes.id_paciente AND refuerzo_vacunas.id_vacuna=vacunas.id_vacuna AND fecha_refuerzo='$fecha' AND refuerzo_vacunas.vacunado='0'" . $criterio;
...
<html>
    ...
    <body class="skin-black">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                                ...
                                <li>
                                    ...
                                    <a href="Form/Usuarios/editar_usuario.php?idusu=<?php echo $_SESSION['idusu']; ?>">
                                ...
                                <li>
                                    <a href="#"><i class="fa fa-ban fa-fw pull-right"></i> Cerrar sesión</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div class="row" style="margin-bottom:5px;">
                        ...
                        <div class="col-md-1">
                            <div class="thumbnail">
                                <img src="../Vacunas/img/logo.gif" alt=""/>
                                    ...
                                    <?php if ($totalRows_listado > 0) { // Show if recordset not empty    ?>
                                        ...
                                        do {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="Form/Refuerzos/listado_refuerzos.php?id_paciente=<?php echo $row_listado['id_paciente']; ?>"<span>Ver vacuna</span></a></td>
                                                <td><a href="../Vacunas/Form/Pacientes/ver_paciente.php?id_paciente=<?php echo $row_listado['id_paciente']; ?>"<span>Información</span></a></td>
                                            </tr>
     ...
     <script>             $(function () {                 $("#datepicker").datepicker();             });         </script>      </body>
</html>
