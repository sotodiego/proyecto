                            ...
                            <div class="col-md-12">
                                <section class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-group" role="form" name="form1" id="form1" method="post" action="../../scripts/agregar_usu.php">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input name="apellido" type="text" class="form-control" id="apellido" required="" placeholder="Apellido...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input name="usuario" type="text" class="form-control" id="usuario" required="" placeholder="Usuario...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input name="clave" type="password" class="form-control" id="clave" required="" placeholder="Clave">
                                            </div>
                                            <div class="form-group col-sm-6">
