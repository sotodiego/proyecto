...
$consulta = mysql_query("SELECT * FROM usuarios WHERE id_usuario='$idusu'");
                            ...
                            <div class="col-md-12">
                                <section class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-group" role="form" name="form1" id="form1" method="post" action="../../scripts/editar_usu.php?idusu=<?php echo $fila['id_usuario']; ?>">

                                            <div class="form-group col-sm-6 ">
                                                <label class="sr-only" >Nombre</label>
                                                <input name="nombre" type="text" class="form-control" value="<?php echo $fila['nombre_usu']; ?>" id="nombre" required="" placeholder="Nombre...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Apellido</label>
                                                <input name="apellido" type="text" class="form-control" value="<?php echo $fila['apellido_usu']; ?>" id="apellido" required="" placeholder="Apellido...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Teléfono</label>
                                                <input name="telefono" type="text" class="form-control" value="<?php echo $fila['telefono_usu']; ?>" id="telefono" placeholder="Teléfono...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Usuario</label>
                                                <input name="usuario" type="text" class="form-control" value="<?php echo $fila['nick_usu']; ?>" id="usuario" required="" placeholder="Usuario...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <select class="form-control ui dropdown" name="cargo" id="cargo">
                                                    <option value="<?php echo $fila['cargo_usu']; ?>"><?php echo $fila['cargo_usu']; ?></option>
                                                    <option value="<?php echo $_SESSION['nickusu']; ?> "><?php echo $_SESSION['nickusu']; ?> </option>
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input name="clave" type="password" class="form-control" value="<?php echo $fila['clave_usu']; ?>" id="clave" required="" placeholder="Clave">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <button type="submit" class="btn btn-success" >Registrar</button>
                                                <!--                                                <button name="boton" type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Registrar</button>
