                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3>Usuarios</h3> 
                                        <p><a href="../Usuarios/agregar_usuario.php" class="btn btn-primary" role="button">Agregar</a> <a href="../Usuarios/listado_usuarios.php" class="btn btn-warning" role="button">Listado</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3>Respaldo</h3>                                       
                                        <p><a href="../Respaldo/backup.php" class="btn btn-primary" role="button">Aceptar</a></p>
                                    </div>
                                </div>
