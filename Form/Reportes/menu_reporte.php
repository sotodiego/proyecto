                    ...
                    <EditableRegion>
                        <div class="row">
                            <div class="col-sm-6 col-md-3">
                                <div class="thumbnail">
                                    <img src="../../img/vacunados.png" alt=""/>
                                    <div class="caption">
                                        <h3>Pacientes Vacunados</h3> 
                                        <p><a href="../Reportes/reporte_vacunados.php" class="btn btn-primary" role="button">Listado</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <div class="thumbnail">
                                    <img src="../../img/vacunados2.png" alt=""/>
                                    <div class="caption">
                                        <h3>Niños vacunados</h3>                                       
                                        <p><a href="../Reportes/reporte_vacunados_ninos.php" class="btn btn-primary" role="button">Listado</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
