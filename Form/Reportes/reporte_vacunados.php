...
if (!empty($chkedad)) {
    ...
    $criterio1 = $criterio1 . " edad_pac <= '" . $edad . "' '%'";
}
if (!empty($chksexo)) {
                                ...
                                <form name="form1" id="form1" action="">
                                    <table class="table table-condensed">
                                        <tr class="form-group col-sm-12 ">
                                            ...
                                            <td>
                                                <input name="fecha1" type="text" class="form-control" id="fecha1 datepicker" placeholder="Desde..." 
                                            ...
                                            <td>
                                                <input name="fecha2" type="text" class="form-control" id="fecha2 datepicker" placeholder="Hasta..." 
