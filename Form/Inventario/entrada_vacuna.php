...
$idvac = $_GET['idvac'];
$consulta = mysql_query("SELECT * FROM vacunas WHERE id_vacuna='$idvac'") or die(mysql_error());
                            ...
                            <div class="col-md-12">
                                <section class="panel panel-info">
                                    <header class="panel-heading">
                                        Entrada de vacunas--><?php echo $fila['nombre_vac'];?>
                                    </header>
                                    <div class="panel-body">
                                        <form class="form-group" role="form" name="form1" id="form1" method="post" action="../../scripts/agregar_entrada.php?idvac=<?php echo $idvac; ?>">


                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Cantidad</label>
                                                <input name="cantidad_entrada" type="text" class="form-control" id="cantidad_entrada" placeholder="Cantidad por ingresar...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Fecha</label>
                                                <input name="fecha_entrada" type="text" class="form-control" id="datepicker" placeholder="Fecha de ingreso...">
                                            </div>


                                            <div class="form-group col-sm-6">
                                                <button type="submit" class="btn btn-success" >Registrar</button>
                                                <a href="../Inventario/listado_cantidad.php"><button type="button" class="btn btn-warning" >Listado</button></a>
                                            </div>
                                        </form>
