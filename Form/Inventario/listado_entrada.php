...
$listado = mysql_query("SELECT * FROM vacunas") or die(mysql_error());
                        ...
                        <div class="col-md-14">
                            <section class="panel tasks-widget panel-info">
                                        ...
                                        <tbody>
                                            <?php while ($fila = mysql_fetch_array($listado)) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $fila['abreviatura_vac']; ?></td>
                                                    <td>
                                                        <a href="entrada_vacuna.php?idvac=<?php echo $fila['id_vacuna']; ?>" <button class="btn btn-default btn-xs" title="Agregar cantidad"><i class="fa fa-plus"></i></button></a>
                                                    </td>
                                                </tr>  
                                            <?php } ?>
                                        </tbody>
                                ...
                                <div class=" add-task-row">
                                    <a class="btn btn-success btn-sm pull-left" href="../Pacientes/agregar_paciente.php">Agregar</a>  
                                    <a class="btn btn-warning btn-sm pull-left" href="../Inventario/listado_cantidad.php">Listado</a>
