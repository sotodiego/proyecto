...
$listado = mysql_query("SELECT * FROM refuerzo_vacunas, vacunas, pacientes WHERE refuerzo_vacunas.id_paciente=pacientes.id_paciente AND refuerzo_vacunas.id_vacuna=vacunas.id_vacuna AND pacientes.id_paciente='$id_paciente' AND refuerzo_vacunas.fecha_refuerzo='$fecha' AND refuerzo_vacunas.vacunado='0'") or die(mysql_error());
$cant_datos = mysql_num_rows($listado);
$idmsg = $_GET['idmsg'];
?>
...
<?php while ($fila = mysql_fetch_array($listado)) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $fila['nombre_pac']; ?></td>
                                                    <td><?php echo $fila['apellido_pac']; ?></td>
                                                    <td><?php echo $fila['nombre_vac']; ?></td>

                                                    <td>
                                                        <button class="btn btn-default btn-xs"  data-toggle="modal" data-target=".bs-example-modal-sm" title="Vacunar"><i class="fa fa-check task-title-sp"></i></button></a>
                                                                            ...
                                                                            <section class="panel panel-info">
                                                                                ...
                                                                                <div class="panel-body">
                                                                                    ...
                                                                                    <div class="form-group col-sm-10">
                                                                                        <a href="../../scripts/editar_refuerzo.php?id_paciente=<?php echo $fila['id_paciente']; ?>&id_vacuna=<?php echo $fila['id_vacuna']; ?>"<button type="button" class="btn btn-success" >Si</button></a>
                                                                                        <a href="../../index.php" <button type="button" class="btn btn-danger" >No</button></a>
...
<?php } ?>
                                ...
                                <div class=" add-task-row">
                                    <a class="btn btn-success btn-sm pull-left" href="../Pacientes/agregar_bebe.php">Agregar</a>
