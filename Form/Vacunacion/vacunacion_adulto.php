...
$cant = mysql_num_rows($listado);
if ($cant == 0) {
    echo "<script> alert('Cedula NO encontrada por favor ingrese los datos del paciente '); location.href='../Pacientes/agregar_paciente.php';</script>";
} else {
                                        ...
                                        <div class="panel-body">
                                            <form class="form-group" role="form" name="form1" id="form1" method="post" action="../../scripts/agregar_vac_adulto.php?id_paciente=<?php echo $fila['id_paciente']; ?>">
                                                ...
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <a href="../Vacunacion/listado_adultos.php"><button type="button" class="btn btn-warning" >Listado</button></a>
                                                </div>
                                            </form>
