...
$listado = mysql_query("SELECT * FROM vacunas");
?>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3>Vacunación</h3> 
                                        <button name="boton" type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Vacunar</button>
                                        <a href="../Vacunacion/listado_adultos.php" class="btn btn-default" role="button">Adultos vacunados</a>
                                        <a href="../Vacunacion/listado_bebes.php" class="btn btn-default" role="button">Bebés vacunados </a>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <section class="panel panel-info">
                                                                    ...
                                                                    <div class="panel-body">
                                                                        <form  action="../Vacunacion/vacunacion_adulto.php" method="get">

                                                                            <div class="form-group col-sm-8 ">
                                                                                <label class="sr-only" >Cédula</label>
                                                                                <input name="cedula" type="text" class="form-control" id="paciente" placeholder="Cédula...">
                                                                            </div>
                                                                            <div class="form-group col-sm-6">
                                                            ...
                                                            <div class="col-md-12">
                                                                <section class="panel panel-info">
                                                                    ...
                                                                    <div class="panel-body">
                                                                        <form  action="../Vacunacion/vacunacion_bebe.php" method="get">

                                                                            <div class="form-group col-sm-10 ">
                                                                                <label class="sr-only" >Cédula</label>
                                                                                <input name="cedula" type="text" class="form-control" id="paciente" placeholder="Cédula representante...">
                                                                            </div>
                                                                            <div class="form-group col-sm-6">
                                                                                <button type="submit" class="btn btn-success" >Envíar</button>
