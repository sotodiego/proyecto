...
$listado = mysql_query("SELECT * FROM salida_inventario, registro_bebes, pacientes WHERE salida_inventario.id_bebe=registro_bebes.id_bebe AND registro_bebes.id_paciente=pacientes.id_paciente") or die(mysql_error());
                                        ...
                                        <tbody>
                                            <?php while ($fila = mysql_fetch_array($listado)) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $fila['cedula_pac']; ?></td>

                                                    <td> <a href="listado_bebes_vacunados.php?id_paciente=<?php echo $fila['id_paciente']; ?>"><button name="boton" type="button" class="btn btn-primary"><i class="fa fa-check task-title-sp"></i></button></td></a>
