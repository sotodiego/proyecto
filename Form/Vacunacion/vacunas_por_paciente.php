...
$listado = mysql_query("SELECT * FROM salida_vacunas, vacunas, pacientes WHERE salida_vacunas.id_paciente=pacientes.id_paciente AND salida_vacunas.id_vacuna=vacunas.id_vacuna AND pacientes.id_paciente='$id_paciente'") or die(mysql_error());
