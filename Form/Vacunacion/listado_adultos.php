...
$listado = mysql_query("SELECT * FROM salida_inventario, pacientes WHERE salida_inventario.id_paciente=pacientes.id_paciente") or die(mysql_error());
                                        ...
                                        <tbody>
                                            <?php while ($fila = mysql_fetch_array($listado)) { ?>
                                                <tr>
                                                    ...
                                                    <td> <a href="listado_adultos_vacunados.php?id_paciente=<?php echo $fila['id_paciente']; ?>"><button name="boton" type="button" class="btn btn-primary"><i class="fa fa-check task-title-sp"></i></button></td></a>
