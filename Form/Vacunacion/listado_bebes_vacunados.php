...
$listado = mysql_query("SELECT * FROM  vacunacion_bebes, vacunas WHERE  vacunacion_bebes.id_paciente='$id_paciente' AND vacunas.id_vacuna=vacunacion_bebes.id_vacuna") or die(mysql_error());
$consulta = mysql_query("SELECT * FROM registro_bebes, vacunacion_bebes, vacunas WHERE registro_bebes.id_bebe=vacunacion_bebes.id_bebe AND vacunacion_bebes.id_paciente='$id_paciente' AND vacunas.id_vacuna=vacunacion_bebes.id_vacuna") or die(mysql_error());
$row_bebe = mysql_fetch_array($consulta);
?>
                        ...
                        <div class="col-md-14">
                            <section class="panel tasks-widget panel-info">
                                <header class="panel-heading">
                                    Vacunas de <?php echo $row_bebe['nombre_bebe'], "  ", $row_bebe['apellido_bebe']; ?>
                                </header>
...
<?php while ($fila = mysql_fetch_array($listado)) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $fila['fecha_bebe']; ?></td>
                                                </tr>  
<?php } ?>
                                        </tbody>
