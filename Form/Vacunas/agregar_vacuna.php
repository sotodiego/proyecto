                            ...
                            <div class="col-md-12">
                                <section class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-group" role="form" name="form1" id="form1" method="post" action="../../scripts/agregar_vac.php">

                                            <div class="form-group col-sm-6 ">
                                                <label class="sr-only" >Códido</label>
                                                <input name="codigo_vac" type="text" class="form-control" id="codigo_vac" required="" placeholder="Código...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Nombre vacuna</label>
                                                <input name="nombre_vac" type="text" class="form-control" id="nombre_vac" required="" placeholder="Nombre de vacuna...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Abreviatura</label>
                                                <input name="abreviatura_vac" type="text" class="form-control" id="abreviatura_vac" required="" placeholder="Abreviatura...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <select class="form-control ui dropdown" name="frecuencia_vac" id="frecuencia_vac">
                                                    <option>Periodo de vacunación (Meses)</option>
                                                    <?php for ($i = 1; $i <= 24; $i++) { ?>
...
<?php } ?>
                                            ...
                                            <div class="form-group col-sm-6">
                                                <input name="cantidad_ref" type="text" class="form-control" id="cantidad_ref" required="" placeholder="Cantidad de refuerzos...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Observaciones</label>
                                                <input name="observacion_vac" type="text" class="form-control" id="observacion_vac" placeholder="Observaciones...">
                                            </div>

                                            <div class="form-group col-sm-6">
                                                <button type="submit" class="btn btn-success" >Registrar</button>
                                                <a href="../Vacunas/listado_vacunas.php"><button type="button" class="btn btn-warning" >Listado</button></a>
                                            </div>
                                        </form>
