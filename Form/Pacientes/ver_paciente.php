...
$consulta = mysql_query("SELECT * FROM pacientes WHERE id_paciente='$id_paciente'");
                            ...
                            <div class="col-md-12">
                                <section class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-group" role="form" name="form1" id="form1" method="post" action="../../scripts/editar_pac.php?id_paciente=<?php echo $fila['id_paciente']; ?>">

                                            <div class="form-group col-sm-6 ">
                                                <label class="sr-only" >Nombre</label>
                                                <input name="nombre_pac" type="text" class="form-control" readonly="readonly" value="<?php echo $fila['nombre_pac']; ?>" title="Nombre" id="nombre_pac" placeholder="Nombre...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Apellido</label>
                                                <input name="apellido_pac" type="text" class="form-control" readonly="readonly" value="<?php echo $fila['apellido_pac']; ?>"  title="Apellido" id="apellido_pac" placeholder="Apellido...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Cedula</label>
                                                <input name="cedula_pac" type="text" class="form-control" readonly="readonly" value="<?php echo $fila['cedula_pac']; ?>"  title="Cédula" id="cedula_pac" placeholder="Cedula...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <select class="form-control ui dropdown" name="sexo_pac" readonly="readonly" value="<?php echo $fila['sexo_pac']; ?>" id="sexo_pac">
                                                    <option value=""><?php echo "Sexo: " . $fila['sexo_pac']; ?></option>

                                                </select>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Fecha de nacimiento</label>
                                                <input name="fecha_pac" type="datetime" class="form-control datepicker" readonly="readonly" value="<?php echo $fila['fecha_pac']; ?>"  title="Fecha de nacimiento" id="fecha_pac" placeholder="Fecha de nacimiento...">

                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Edad</label>
                                                <input name="edad_pac" type="text" class="form-control" readonly="readonly" value="<?php echo $fila['edad_pac']; ?>" title="Edad" id="edad_pac" placeholder="Edad...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Telefono</label>
                                                <input name="telefono_pac" type="text" class="form-control" readonly="readonly" value="<?php echo $fila['telefono_pac']; ?>"  title="Teléfono" id="telefono_pac" placeholder="Teléfono...">
                                            </div>

                                            <div class="form-group col-sm-6">
                                                <label class="sr-only">Direccion</label>
                                                <input name="direccion_pac" type="text" class="form-control" readonly="readonly" value="<?php echo $fila['direccion_pac']; ?>"  title="Dirección" id="direccion_pac" placeholder="Direccion">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only">Observaciones</label>
                                                <input name="observacion_pac" type="text" class="form-control" readonly="readonly"  value="<?php echo $fila['observacion_pac']; ?>"  title="Observación" id="observacion_pac" placeholder="observacion_pac...">
                                            </div>
                                            <div class="form-group col-sm-6">
