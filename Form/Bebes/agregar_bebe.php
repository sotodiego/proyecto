                            ...
                            <div class="col-md-12">
                                <section class="panel panel-info">
                                    <header class="panel-heading">
                                        Agregar bebé al representante
                                    </header>
                                    <div class="panel-body">
                                        <form class="form-group" role="form" name="form1" id="form1" method="post" action="../../scripts/agregar_bebe.php?id_paciente=<?php echo $fila['id_paciente']; ?>">

                                            <div class="form-group col-sm-6 ">
                                                <label class="sr-only" >Nombre</label>
                                                <input name="nombre_bebe" type="text" class="form-control" id="nombre_bebe" required="" placeholder="Nombre...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Apellido</label>
                                                <input name="apellido_bebe" type="text" class="form-control" id="apellido_bebe" required="" placeholder="Apellido...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Partida</label>
                                                <input name="partida_bebe" type="text" class="form-control" id="partida_bebe" required="" placeholder="Partida del bebé...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <select class="form-control ui dropdown" name="sexo_bebe" id="sexo_bebe">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input name="fecha_bebe" type="datetime" class="form-control" id="datepicker" required="" placeholder="Fecha de nacimiento...">

                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Edad</label>
                                                <input name="edad_bebe" type="text" class="form-control" id="edad_bebe" placeholder="Edad...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Meses</label>
                                                <input name="meses_bebe" type="text" class="form-control" id="meses_bebe" placeholder="Meses...">
                                            </div>
...
<!--        <script src="../../js/jquery.min.js" type="text/javascript"></script>
        ...
        <script>
            ...
            {
                var hoy = new Date();
                var fecha_nac = new Date(document.form1.fecha_bebe.value);
                var edad = hoy.getFullYear() - fecha_nac.getFullYear();

                if (hoy.getMonth() > fecha_nac.getMonth()) {
                } else if (hoy.getMonth() < fecha_nac.getMonth()) {
                    edad--;
                } else {
                    if (hoy.getDate() < fecha_bebe.getDate()) {
                        edad--;
                    }
                }
                return document.form1.edad_bebe.value = edad;
