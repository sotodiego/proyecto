<?php
require("../../conexion.php");require ("../../scripts/restringir_acceso.php");
$id_bebe = $_GET['id_bebe'];
$consulta = mysql_query("SELECT * FROM registro_bebes WHERE id_bebe='$id_bebe'");
                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav">  
                        <div style="float:left">                
                            <img src="../../img/cintillo.png"  height="50" width="100%">  
                        </div>
                            ...
                            <div class="col-md-12">
                                <section class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-group" role="form" name="form1" id="form1" method="post" action="../../scripts/editar_bebe.php?id_bebe=<?php echo $fila['id_bebe']; ?>">

                                            <div class="form-group col-sm-6 ">
                                                <label class="sr-only" >Nombre</label>
                                                <input name="nombre_bebe" type="text" class="form-control" readonly="readonly" value="<?php echo $fila['nombre_bebe']; ?>" title="Nombre" id="nombre_bebe" placeholder="Nombre...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Apellido</label>
                                                <input name="apellido_bebe" type="text" class="form-control" readonly="readonly" value="<?php echo $fila['apellido_bebe']; ?>"  title="Apellido" id="apellido_bebe" placeholder="Apellido...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Cedula</label>
                                                <input name="partida_bebe" type="text" class="form-control" readonly="readonly" value="<?php echo $fila['partida_bebe']; ?>"  title="Partida" id="cedula_bebe" placeholder="Partida...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <select class="form-control ui dropdown" name="sexo_bebe" readonly="readonly" value="<?php echo $fila['sexo_bebe']; ?>" id="sexo_bebe">
                                                    <option value=""><?php echo "Sexo: " . $fila['sexo_bebe']; ?></option>

                                                </select>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Fecha de nacimiento</label>
                                                <input name="fecha_bebe" type="datetime" class="form-control datepicker" readonly="readonly" value="<?php echo $fila['fecha_bebe']; ?>"  title="Fecha de nacimiento" id="fecha_bebe" placeholder="Fecha de nacimiento...">

                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Edad</label>
                                                <input name="edad_bebe" type="text" class="form-control" readonly="readonly" value="<?php echo $fila['edad_bebe']; ?>" title="Edad" id="edad_bebe" placeholder="Edad...">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="sr-only" >Meses</label>
                                                <input name="meses_bebe" type="text" class="form-control" readonly="readonly" value="<?php echo $fila['meses_bebe']; ?>" title="Meses" id="meses_bebe" placeholder="Meses...">
                                            </div>

                                            <div class="form-group col-sm-6">

                                                <a href="../Bebes/listado_bebes.php"><button type="button" class="btn btn-warning" >Listado</button></a>
                                            </div>
                                        </form>
